...
import static com.example.risknarrative.utils.TestUtils.getOfficerSearchResults;
...
public class TruProxyClientTest {
    ...
    private String mockedTrunarrativeApiUrl = "http://trunarritive.cloud";
    private String mockedApiKey = "mockedKey";
    ...
    public void shouldFailWhenUknownExceptionOccurs() {
        ...
        // when
        assertThrows(TruProxyClientException.class, () -> {
            truProxyClient.searchCompany(companyNumber);
        });
    ...
    public void shouldReturnOfficersResultsSuccessfully() {
        ...
        when(
                ...
                thenReturn(ResponseEntity.ok(getOfficerSearchResults()));
    ...
    public void shouldFailWhenUknownExceptionOccursForOfficersSearch() {
        ...
        // when
        assertThrows(TruProxyClientException.class, () -> {
            truProxyClient.searchOfficers(companyNumber);
        });
