package com.lexisnexis.risknarrative.service;

import com.lexisnexis.risknarrative.dto.*;
import com.lexisnexis.risknarrative.repository.CompanyRepository;
import com.lexisnexis.risknarrative.truproxyclient.*;
...
public class CompanySearchServiceTest {
    ...
    public void shouldUseCompanyNameWhenOnlyCompanyNameIsProvided() {
        ...
        TruProxyCompanyResults stubbedCompanyResults = TestUtils.getOneCompanySearchResults();
        TruProxyOfficerResults stubbedOfficerResults = TestUtils.getOfficerSearchResults();
    ...
    public void shouldUseCompanyNumberWhenBothFieldsAreProvided() {
        ...
        TruProxyCompanyResults stubbedCompanyResults = TestUtils.getOneCompanySearchResults();
        TruProxyOfficerResults stubbedOfficerResults = TestUtils.getOfficerSearchResults();
        Company companyDTO = TestUtils.getCompanyDTOFromTruProxyDTOs(stubbedCompanyResults.items().get(0), stubbedOfficerResults);
